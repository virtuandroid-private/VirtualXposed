    ...
    private static LauncherActivityInfo makeLauncherActivityInfo(Context context, ResolveInfo resolveInfo, UserHandle userHandle) {
        try {
            if (Build.VERSION.SDK_INT > 30 || (Build.VERSION.SDK_INT == 30 && Build.VERSION.PREVIEW_SDK_INT != 0)) {
                ...
                Object launcherActivityInfoInternal;
                LauncherActivityInfo launcherActivityInfo;
                if (Build.VERSION.SDK_INT >= 36) {
                    Constructor<?> LauncherActivityInfoInternal_cons = infoInternalClass.getConstructor(ActivityInfo.class, IncrementalStatesInfo_Class, UserHandle.class, boolean.class);
                    Constructor<LauncherActivityInfo> constructor = LauncherActivityInfo.class.getDeclaredConstructor(Context.class, infoInternalClass);
                    constructor.setAccessible(true);
                    launcherActivityInfoInternal = LauncherActivityInfoInternal_cons.newInstance(resolveInfo.activityInfo, null, userHandle, false);
                    launcherActivityInfo = constructor.newInstance(context, launcherActivityInfoInternal);
                } else  if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
                    Constructor<?> LauncherActivityInfoInternal_cons = infoInternalClass.getConstructor(ActivityInfo.class, IncrementalStatesInfo_Class, UserHandle.class);
                    Constructor<LauncherActivityInfo> constructor = LauncherActivityInfo.class.getDeclaredConstructor(Context.class, infoInternalClass);
                    constructor.setAccessible(true);
                    launcherActivityInfoInternal = LauncherActivityInfoInternal_cons.newInstance(resolveInfo.activityInfo, null, userHandle);
                    launcherActivityInfo = constructor.newInstance(context, launcherActivityInfoInternal);
                } else {
                    ...
                    constructor.setAccessible(true);
                    launcherActivityInfoInternal = LauncherActivityInfoInternal_cons.newInstance(resolveInfo.activityInfo, null);
                    launcherActivityInfo = constructor.newInstance(context, userHandle, launcherActivityInfoInternal);
                }
