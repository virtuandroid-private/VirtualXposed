...
public class VEnvironment {
    ...
    public static File getPermissionFile() {
        return new File(getSystemSecureDirectory(), "permissions.xml");
    }

    public static File getMediaAudioFile() {
        return new File(getMediaStoreDirectory(), "media-audio.json");
    }

    public static File getMediaVideoFile() {
        return new File(getMediaStoreDirectory(), "media-video.json");
    }

    public static File getMediaImageFile() {
        return new File(getMediaStoreDirectory(), "media-image.json");
    }
    ...
    public static File getVirtualStorageBaseDir() {
        ...
        if (externalStorageDirectory != null) {
            File vBaseDir = new File(externalStorageDirectory, "VirtualXposed");
    ...
    public static File getVirtualStorageDir(int userId) {
    ...
    public static File getVirtualPrivateStorageDir(int userId) {
        String base = String.format(Locale.ENGLISH, "%s/Android/data/%s/%s/%d", getExternalStorageDirectory(),
    ...
    public static File getMediaStoreDirectory() {
        return ensureCreated(new File(getSystemSecureDirectory(), "mediastore"));
    }
    ...
    public static String getSharedPreferencesFile() {
        return "com.lody.virtual.PREFERENCE_FILE";
    }
}
