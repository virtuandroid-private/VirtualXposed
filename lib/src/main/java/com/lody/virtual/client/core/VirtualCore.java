...
import mirror.android.permission.PermissionManager;
...
public final class VirtualCore {
    ...
    public void startup(Context context) throws Throwable {
        if (!isStartUp) {
            ...
            VASettings.STUB_CP_AUTHORITY = packageName + "." + VASettings.STUB_DEF_AUTHORITY;
            ServiceManagerNative.SERVICE_CP_AUTH = packageName + "." + ServiceManagerNative.SERVICE_DEF_AUTH;
            this.context = context;
            mainThread = ActivityThread.currentActivityThread.call();
            unHookPackageManager = context.getPackageManager();
            hostPkgInfo = unHookPackageManager.getPackageInfo(packageName, PackageManager.GET_PROVIDERS);
            detectProcessType();
            InvocationStubManager invocationStubManager = InvocationStubManager.getInstance();
            invocationStubManager.init();
            invocationStubManager.injectAll();
            ContextFixer.fixContext(context);
            // Disable system permission cache to force VPermissionManager system to be used
