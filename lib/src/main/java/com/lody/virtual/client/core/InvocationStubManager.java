...
import com.lody.virtual.client.hook.proxies.nsd.NsdServiceStub;
...
public final class InvocationStubManager {
	...
	private void injectInternal() throws Throwable {
		...
		if (VirtualCore.get().isVAppProcess()) {
			...
			addInjector(new NsdServiceStub());
	...
	/**
	 * Removes a specific proxied method from a specific IInjector
	 * @param injectorClass the injector that has a reference of the method
	 * @param methodName the name of the method to be removed
	 * @return true if the operation is successful, false otherwise
	 */
	public static <T extends IInjector, H extends MethodInvocationStub> boolean removeMethodProxy(Class<T> injectorClass, final String methodName) {
		H methodInvocationStub = InvocationStubManager.getInstance().getInvocationStub(injectorClass);
	...
	/**
	 * Adds a specific proxied method to a specific IInjector
	 * @param injectorClass the injector that will hold a reference of the method to be proxied
	 * @param proxy the MethodProxy object to be injected
	 * @return true if the operation is successful, false otherwise
	 */
	public static <T extends IInjector, H extends MethodInvocationStub> boolean insertMethodProxy(Class<T> injectorClass, MethodProxy proxy) {
		H methodInvocationStub = InvocationStubManager.getInstance().getInvocationStub(injectorClass);
		if(methodInvocationStub == null) return false;
