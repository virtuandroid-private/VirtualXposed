...
public class MethodProxies {
    ...
    static class AddGpsStatusListener extends ReplaceLastPkgMethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            checkMinimumLocationPermission(Manifest.permission.ACCESS_FINE_LOCATION);
    ...
    static class RequestLocationUpdates extends ReplaceLastPkgMethodProxy {
        ...
        public Object call(final Object who, Method method, Object... args) throws Throwable {
            ...
            checkMinimumLocationPermission(Manifest.permission.ACCESS_COARSE_LOCATION);
    ...
    static class AddNmeaListener extends MethodProxy {
    ...
    static class RemoveProximityAlert extends MethodProxy {
    ...
    private static void checkMinimumLocationPermission(String minimumPermission) throws SecurityException {
        final int pid = VBinder.getCallingPid();
        final int uid = VBinder.getCallingUid();

        if(VPermissionManager.get().checkPermission(minimumPermission, uid)
                == PackageManager.PERMISSION_DENIED) {
            String failReason = " does not have " + minimumPermission + ".";
            throw new SecurityException("Permission Denial: accessing "
                    + ProviderHook.class.getSimpleName() + " from pid=" + pid
                    + ", uid=" + uid + failReason);
        }
    }
