...
public class ISmsStub extends BinderInvocationProxy {
    ...
    protected void onBindMethods() {
        ...
        addMethodProxy(new ReplaceSpecPkgMethodProxy("sendTextForSubscriber", 1) {
            ...
            public Object call(Object who, Method method, Object... args) throws Throwable {
                checkPermission(Manifest.permission.SEND_SMS, "Sending SMS message");
    ...
    static private void checkPermission(String permission, String reason) throws SecurityException {
        final int pid = VBinder.getCallingPid();
        final int uid = VBinder.getCallingUid();

        if(VPermissionManager.get().checkPermission(permission, uid)
                == PackageManager.PERMISSION_DENIED) {
            String failReason = " does not have " + permission + ".";
            throw new SecurityException("Permission Denial: " + reason
                    + " from pid=" + pid
                    + ", uid=" + uid + failReason);
        }
    }
