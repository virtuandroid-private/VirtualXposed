...
class MethodProxies {
    ...
    private static int getFlags(final Object arg) {
        int flags;
        try {
            flags = (int) arg;
        } catch (java.lang.ClassCastException e) {
            // Double cast to avoid ClassCastException
            flags = (int) ((long) arg);
        }
        return flags;
    }

    private static List<ResolveInfo> fixHostResult(final Object _hostResult, final boolean slice) {
        final Object hostResult = slice
            ? ParceledListSlice.getList.call(_hostResult)
            : _hostResult;
    ...
    static class CanRequestPackageInstalls extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            System.out.println("Can request package installs");
            return VPackageManager.get().canRequestPackageInstalls();
        }
                    ...
                    new InvocationHandler() {
                        ...
                        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                            switch (method.getName()) {
                                ...
                                case "abandonSession": {
                                    vInstaller.abandonSession(getFlags(args[0]));
                                    return 0;
                                }
                                case "openSession": {
                                    return vInstaller.openSession(getFlags(args[0]));
                                }
                                case "getSessionInfo": {
                                    SessionInfo info = vInstaller.getSessionInfo(getFlags(args[0]));
                                    if (info != null) {
                                        return info.alloc();
                                    }
                                    return null;
                                ...
                                case "getAllSessions": {
                                    return ParceledListSliceCompat.create(
                                            vInstaller.getAllSessions(getFlags(args[0])).getList()
                                    );
                                }
                                case "getMySessions": {
    ...
    static class QueryIntentServices extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            List<ResolveInfo> appResult = VPackageManager.get().queryIntentServices((Intent) args[0],
                    (String) args[1], getFlags(args[2]), userId);
            Object _hostResult = method.invoke(who, args);
            if (_hostResult != null) {
                List<ResolveInfo> hostResult = fixHostResult(_hostResult, slice);
                if (hostResult != null) {
    ...
    static class CheckPermission extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            return VPackageManager.get().checkPermission(permName, pkgName, getVUid());
        }
