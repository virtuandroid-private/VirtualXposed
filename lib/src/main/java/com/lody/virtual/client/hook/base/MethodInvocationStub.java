...
public class MethodInvocationStub<T> {
     ...
     * @return the Method proxy object, or null if not successful
     */
    public MethodProxy removeMethodProxy(MethodProxy methodProxy) {
        if (methodProxy != null) {
            return removeMethodProxy(methodProxy.getMethodName());
        }
        return null;
    }
